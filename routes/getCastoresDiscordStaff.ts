...
const getCastoresDiscordStaff = async (req: Request, res: Response) => {
    ...
    setCache("reformaDiscordStaff", {
        data: roleMembers,
    });
    res.send(roleMembers);
};

export default getCastoresDiscordStaff;
