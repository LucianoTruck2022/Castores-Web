...
const CastoresStaffExterno = () => {
    document.title = TITLE + " | Castores Events";
    ...
    const [loading, error, succes, bodyResponse] = useFetch(
        `${REST_API_URL}/getReformaDiscordStaffCEvents`,
        "GET",
        {
        ...
        <>
            <div className="flex justify-center m-2">
                <Typography color={themeTatailwind.primary.color} variant="h4">
                    <b>{lang.sys.castores_staff_externo_page.title}</b>
                </Typography>
            </div>
            {!Response && !loading && (
                <ErrorData
...
export default CastoresStaffExterno;
