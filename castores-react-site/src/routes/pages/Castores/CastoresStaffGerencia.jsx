...
const CastoresStaffGerencia = () => {
    document.title = TITLE + " | VTC Staff | Gerencia & Manager";
    ...
    const [loading, error, succes, bodyResponse] = useFetch(
        `${REST_API_URL}/getCastoresDiscordStaff`,
        "GET",
        {
        ...
        <>
            <div className="flex justify-center m-2">
                <Typography color={themeTatailwind.primary.color} variant="h4">
                    <b>{lang.sys.reforma_staff_gerencia_page.title}</b>
                </Typography>
            </div>
            {!Response && !loading && (
                <ErrorData
...
export default CastoresStaffGerencia;
