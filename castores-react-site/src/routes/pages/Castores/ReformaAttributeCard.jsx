    ...
    return (
        ...
        >
            ...
            <Chip
                ...
                label={
                    <b>
                        {lang.downloads.atribute_card_free.last_update}{" "}
                        <i>{lastUpdate}</i>
                    </b>
                }
                avatar={<UpdateIcon />}
            ...
            <div className="flex justify-center gap-5">
                <Button
                    ...
                    target="_blank"
                >
                    {lang.downloads.atribute_card_free.download_btn}
                </Button>
                {patreonLink && (
                    <Button
...
export default ReformaAttributeCard;
