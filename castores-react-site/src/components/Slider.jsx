...
import slide6 from "../static/img/slide_img/6.webp";
import slide7 from "../static/img/slide_img/7.webp";
import slide8 from "../static/img/slide_img/8.webp";
...
const Slider = () => {
    ...
    return (
        <div className="flex relative max-h-96 h-auto max-w-full rounded-b-2xl justify-center border-b-4 overflow-hidden border-[#2E3192] m-2">
