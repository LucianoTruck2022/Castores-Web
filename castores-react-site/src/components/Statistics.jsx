...
const Statistics = () => {
    ...
    const renderStatistics = () => {
        const classStyle = `flex flex-col ${themeTatailwind.secundary.main_contrast} shadow-2xl w-full max-w-xs items-center rounded-xl gap-2 p-4`;
                ...
                <div className="flex flex-col md:flex-row gap-5 items-center md:justify-center">
                    <div className={classStyle}>
                        <div className="flex flex-col items-center gap-1">
                            ...
                            >
                                {lang.sys.vtc_page.statistics.last_recruit}
                            </Typography>
                        </div>
                        ...
                        {StatisticsResponse.last_member !== null ? (
                            ...
                            >
                                {
                                    lang.sys.vtc_page.statistics
                                        .last_recruit_not_found
                                }
                            </Typography>
                        )}
                    </div>
                    ...
                    <div className={classStyle}>
                        <div className="flex flex-col items-center gap-1">
                            ...
                            <Typography
                                ...
                                color={themeTatailwind.primary.color}
                            >
                                {lang.sys.vtc_page.statistics.total_drivers}
                            </Typography>
                        </div>
                        <Divider className="w-full" component="div" />
                        <Typography
                    ...
                    <div className={classStyle}>
                        <div className="flex flex-col items-center gap-1">
                            ...
                            <Typography
                                ...
                                color={themeTatailwind.primary.color}
                            >
                                {lang.sys.vtc_page.statistics.active_staff}
                            </Typography>
                        </div>
                        <Divider className="w-full" component="div" />
                        <Typography
    ...
    return (
        <div className="flex flex-col md:flex-row justify-center mb-10">
            <div
                className={`flex flex-col justify-center ${themeTatailwind.secundary.main} md:max-w-7xl md:w-full rounded-lg shadow-xs gap-4 m-5 p-5`}
            >
                <Typography
                    color={themeTatailwind.primary.color}
                    component="div"
                    className="flex items-center justify-center align-top gap-2"
                    variant="h4"
                >
                    <QueryStatsRoundedIcon fontSize="large" />
                    <b>{lang.sys.vtc_page.statistics.title}</b>
                </Typography>
                <Divider />
                {StatisticsResponse !== undefined ? (
                    ...
                    <Typography
                        ...
                        component="div"
                    >
                        {lang.sys.vtc_page.statistics.not_statistics_found}
                    </Typography>
                )}
            </div>
            <NextEvent />
