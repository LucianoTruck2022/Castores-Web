...
import { SvgIcon, Typography, Link } from "@mui/material";
...
const FooterCastores = () => {
    ...
    const social = [
        {
            name: "Instagram",
            logo: <InstagramIcon />,
            link: "https://instagram.com/castorestruckingoficial",
        },
        {
            name: "Facebook",
            logo: <FacebookIcon />,
            link: "https://www.facebook.com/CastoresTruckingOficial",
        },
        {
            name: "Twitter",
            logo: <XIcon />,
            link: "https://x.com/CastoresT2024",
        },
        {
            name: "YouTube",
            logo: <YouTubeIcon />,
            link: "https://www.youtube.com/@LucianoTruck22",
        },
        {
            name: "Twitch",
            logo: <IconBrandTwitch />,
            link: "https://www.twitch.tv/castorestruckingoficial",
        },
        {
            name: "TikTok",
            logo: <IconBrandTiktok />,
            link: "https://tiktok.com/@castorestruckingoficial",
        },
        {
            name: "Discord",
            logo: (
            ...
            link: "https://discord.gg/cTtV44CE9J",
        },
        {
            name: "TruckersMP",
            logo: (
    ...
    const iconList = (key, link, name, logo) => {
        return (
            <li className="mr-3 ml-3" key={key}>
                <Link
        ...
        <div className="flex flex-col w-full justify-end">
            <div className="flex justify-center p-2 drop-shadow-md">
                ...
                <Typography color={themeTatailwind.primary.color} variant="h4">
                    <b>Castores Trucking VTC</b>
                </Typography>
            </div>
            <div className="flex justify-center p-2">
                <Typography color={themeTatailwind.primary.color}>
                    {lang.footer.team_reforma_vtc.description}&nbsp;
                </Typography>
            ...
            <div className="flex flex-col justify-center items-center mb-3 mt-3">
                <ul className="justify-center md:inline-flex">
                    {social
                        .slice(0, 3)
                        .map((obj, index) =>
                            iconList(index, obj.link, obj.name, obj.logo)
                        )}
                </ul>
                <ul className="justify-center md:inline-flex">
                    {social
