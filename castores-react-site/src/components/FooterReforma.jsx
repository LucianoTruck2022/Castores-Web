...
// icons
import reformaLogo from "../static/img/reforma/logoReforma.webp";
    ...
    const social = [
        {
            name: "Instagram",
            logo: <InstagramIcon />,
            link: "https://instagram.com/team.reforma",
        },
        {
            name: "Facebook",
            logo: <FacebookIcon />,
            link: "https://www.facebook.com/TeamReforma",
        },
        {
            name: "YouTube",
            logo: <YouTubeIcon />,
            link: "https://www.youtube.com/@teamreforma105",
        },
        {
            name: "Twitter",
            logo: <TwitterIcon />,
            link: "https://x.com/TeamReformaMod",
        },
        {
            name: "Discord",
            logo: (
        ...
        <div className="flex flex-col md:max-w-xl w-full">
            ...
            <div className="flex justify-center p-2">
                <Typography color={themeTatailwind.primary.color}>
                    {lang.footer.team_reforma_map.description}
                </Typography>
            </div>
